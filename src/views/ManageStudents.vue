<template>
  ...
  <v-container>
    <v-row justify="space-around">
      <v-col cols="3">
        <v-card title="Filter Department" variant="outlined">
          <v-select :items="departments" label="Department" v-model="departmentFilter"></v-select>
          <v-btn @click="clearDepartmentFilter" variant="outlined">Clear Filter</v-btn>
        </v-card>
      </v-col>
      <v-col cols="3">
        <v-card title="Filter Semester" variant="outlined">
          <v-select :items="semesters" label="Month" v-model="semesterFilter"></v-select>
          <v-btn @click="clearSemesterFilter" variant="outlined">Clear Filter</v-btn>
        </v-card>
      </v-col>
    </v-row>
  </v-container>
